...
namespace Meangpu.Util
{
    public class ScrollMeshRendererTexture : MonoBehaviour
    {
        ...
        protected virtual void FixedUpdate() => _renderer.material.mainTextureOffset = new(Time.realtimeSinceStartup * _scrollSpeed.x, Time.realtimeSinceStartup * _scrollSpeed.y);
